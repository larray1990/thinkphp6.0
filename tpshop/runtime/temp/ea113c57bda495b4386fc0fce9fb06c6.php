<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:42:"./template/pc/rainbow/goods\goodsInfo.html";i:1540260094;s:78:"F:\phpstudy_pro\WWW\larray\study\tpshop\template\pc\rainbow\public\header.html";i:1540260094;s:91:"F:\phpstudy_pro\WWW\larray\study\tpshop\template\pc\rainbow\goods\goodsInfoCombination.html";i:1540260094;s:86:"F:\phpstudy_pro\WWW\larray\study\tpshop\template\pc\rainbow\goods\goodsInfoDetail.html";i:1540260094;s:78:"F:\phpstudy_pro\WWW\larray\study\tpshop\template\pc\rainbow\public\footer.html";i:1540260094;s:84:"F:\phpstudy_pro\WWW\larray\study\tpshop\template\pc\rainbow\public\sidebar_cart.html";i:1540260094;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
					...
					<div class="item">
						...
						<div class="cata-nav-layer">
							...
							<div class="advertisement_down">
								<?php $pid =100+$kr;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1562241600 and end_time > 1562241600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
...
foreach($result as $key=>$v3):       
    ...
    ?>
							...
							<?php $pid =51;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1562241600 and end_time > 1562241600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
