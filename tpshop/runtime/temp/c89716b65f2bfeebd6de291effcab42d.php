<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view/promotion\flash_sale.html";i:1540260088;s:81:"E:\phpstudy_pro\WWW\larray\study\tpshop\application\admin\view\public\layout.html";i:1540260088;}*/ ?>
<!doctype html>
<html>
<head>
						...
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 80px;">
									<?php if($vo[is_end] == 0): ?>
										<span class="yes" onClick="changeTableVal2('flash_sale','id','<?php echo $vo['id']; ?>','is_end',this,'是','否','<?php echo $vo['status_desc']; ?>')" ><i class="fa fa-check-circle"></i>是</span>
										<?php else: ?>
										<span class="no" onClick="changeTableVal2('flash_sale','id','<?php echo $vo['id']; ?>','is_end',this,'是','否')" ><i class="fa fa-ban"></i>否</span>
									<?php endif; ?>
								</div>
							</td>
