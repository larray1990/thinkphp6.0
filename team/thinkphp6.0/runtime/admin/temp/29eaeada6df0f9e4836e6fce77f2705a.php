<?php /*a:1:{s:54:"D:\www\larray\team\basetp6\view\admin\index\index.html";i:1575444851;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    <div id="LAY_WRAP">
        <div id='LAY_app' class="layui-side layui-bg-black">
            <div class="layui-side-scroll">
                <div class="layui-logo" lay-href=""><span>后台管理系统</span></div>
                ...
                <ul class="layui-nav layui-nav-left layui-nav-tree" lay-filter="layui-nav-left">
                    ...
                    <li data-name="<?php echo htmlentities($vo['title']); ?>" class="layui-nav-item">
                        <a lay-href="<?php if($vo['name'] == 'javascript:;'): ?>javascript:;<?php else: ?><?php echo url($vo['name']); ?><?php endif; ?>"
                           lay-tips="<?php echo htmlentities($vo['title']); ?>" lay-direction="2">
        ...
        <div class="layui-body" id="LAY_app_body">
            <div class="layui-header">
                ...
                <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                    ...
                    <li class="layui-nav-item" lay-unselect="">
                        <a href="javascript:;"> <span><?php echo session('admin_full_name'); ?></span> <span
    ...
    <div id='setbgcolor' style="display:none">
        <div class="layui-layer-shade" id="setbgcolorshade"
             style="z-index: 19891016; background-color: rgb(0, 0, 0); opacity: 0.3;"></div>
