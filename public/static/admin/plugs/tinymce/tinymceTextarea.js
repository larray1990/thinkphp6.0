...
layui.define(['jquery'], function (exports) {
    var $ = layui.$;
    var modFile = layui.cache.modules['tinymceTextarea'];
    var modPath = modFile.substr(0, modFile.lastIndexOf('/')) + '/tinymce';
    ...
    var settings = {
        base_url: modPath,
        images_upload_url: "/admin/Uploads/uploadImage" //图片上传接口，可在option传入，也可在这里修改，option的值优先
            ,
    ...
    t.getContent=function (elem){
       return tinymce.editors[elem].getContent();
    }
    //重载
