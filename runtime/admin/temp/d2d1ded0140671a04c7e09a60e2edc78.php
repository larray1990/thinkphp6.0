<?php /*a:2:{s:55:"D:\www\larray\team\basetp6\view\admin\system\index.html";i:1589180328;s:59:"D:\www\larray\team\basetp6\view\admin\..\layouts\admin.html";i:1591325975;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <?php if(in_array('admin/System/form',$ca_path_arr)){?>
        <button class="layui-btn" data-url="<?php echo url('System/form'); ?>" data-title="添加角色" data-width="30%" data-height="250px"
            lay-event="add"><i class="layui-icon layui-icon-add-1"></i>添加</button>
        <?php }if(in_array('admin/System/destroy',$ca_path_arr)){?>
        <button class="layui-btn layui-btn-danger" data-title="确定批量删除？" data-url='<?php echo url("System/destroy"); ?>?id={{d.id}}'
...
<script type="text/html" id="options">
    <?php if(in_array('admin/System/form',$ca_path_arr)){?>
<a class="layui-btn layui-btn-normal layui-btn-xs" data-url="<?php echo url('System/form'); ?>?id={{d.id}}" data-title="编辑角色"
    data-width="40%" data-height="40%" lay-event="edit" data-table-id="dataTableId"><i
        class="layui-icon layui-icon-edit"></i>编辑</a>
<?php }if(in_array('admin/System/destroy',$ca_path_arr)){?> {{# if(d.id != 1){ }}
<a class="layui-btn layui-btn-danger layui-btn-xs" data-title="确定删除？" data-url='<?php echo url("System/destroy"); ?>?id={{d.id}}'
...
<script>
    layui.use(['common'], function () {
        ...
        common.table('<?php echo htmlentities($title); ?>', "<?php echo url('system/data'); ?>", [
            [{
                type: "checkbox",
                fixed: "left"
            }, {
